...
qsgg:{
    ...
    "data":[{
        "rowkeySource":"rowkey来源",
        "rowkey":"md5",
        "rowId":"非正常认定日期+纳税人识别号+纳税人名称+欠税币额/期末欠税余额+证件号码+当前新发生的欠税余额",
        "nsrmc" : "纳税人名称",
        "nsrlx" : "纳税人类型",    
        "nsrsbh" : "纳税人识别号",
        "fddbr" : "负责人姓名或法定代表人",
...
xzxk:{
    ...
    "data":[{
        "rowkeySource":"rowkey来源",
        "rowkey":"md5",
        "rowId" : "行政许可决定文书号+统一社会信用代码+纳税人识别号+纳税人名称",
        "xmmc" : "项目名称",
        "xzxkjdwsh" : "行政许可决定文书号",
        "splb" : "审批类别  ",
        "xknr" : "许可内容",
...
zdsswf:{
    ...
    "data":[{
        "rowkeySource":"rowkey来源",
        "rowkey":"md5",
        "rowId":"纳税人识别号+纳税人名称+案件性质+主要违法事实",
         "nsrmc" : "纳税人名称",
        "nsrsbh" : "纳税人识别码",
        "zzjgdm" : "组织机构代码",
        "dom" : "注册地址",
...
xzcf:{
    ...
    "data":[{
        "rowkeySource":"rowkey来源",
        "rowkey":"md5",
        "rowId":"行政处罚决定文书号+统一社会信用代码+案件名称+法定代表人",
        "xzcfjdwsh" : "行政处罚决定文书号",
        "ajmc" : "案件名称",
...
fzch:{
    ...
    "data":[{
        "rowkeySource":"rowkey来源",
        "rowkey":"md5",
        "rowId":"非正常认定日期+纳税人识别号+纳税人名称+欠税金额+法定代表人身份证号码+当前新发生的欠税金额",
        "zggsjg" : "主管国税机关",
        "nsrsbh" : "纳税人识别号",
        "nsrmc" : "纳税人名称",
        "fddbr" : "法定代表人",
...
gtgshde:{
    ...
    "data":[{
        ...
        "ynsl":"应纳税额",
        "sl":"税率",
        "hdzxqxksrq":"核定执行期限开始日期",
        "hdzxqxjzrq":"核定执行期限截止日期",
        "qzdbz":"起征点标志",
        "lrrq":"录入日期",
        "zgswjg":"主管税务机关",
        "ssgly":"税收管理员",
